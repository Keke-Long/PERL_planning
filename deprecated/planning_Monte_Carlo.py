...
from HV_Prediction.Physical_model.IDM import IDM
...
if __name__ == "__main__":
    ...
    hv_trajectory = [Vehicle(-5, 15, 0)]  # HV初始状态
    ...
    for t in tqdm(range(1,len(hv_refer_trajectory))):
        ...
        for _ in range(5000):
            ...
            # CAV预测step_num个步长
            step_num = 10
            CAV_trajectory_try = generate_CAV_trajectory(CAV_trajectory_try, step_num)
