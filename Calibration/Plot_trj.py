...
df = pd.read_csv('F:/CATS_Lab/AstaZero/Data/ASta_050719_platoon1.csv', skiprows=range(5))
...
fig, ax = plt.subplots()
ax.plot(df['Time'], df['Speed4'], label='Speed4')
ax.plot(df['Time'], df['Speed5'], label='Speed5')
